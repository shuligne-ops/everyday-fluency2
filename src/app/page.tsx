          ...
          {!userEmail ? (
            <div style={{
              ...
              <h2 style={{
                ...
                Подписка открывает весь курс — 180 уроков, все уровни
              </h2>
              <p style={{ color: '#666', fontSize: '15px', marginBottom: '24px', lineHeight: 1.5 }}>
                Знакомое перестаёт проскакивать мимо не за один диалог, а когда таких диалогов набирается несколько десятков. Дальше — все 180 уроков курса: уроки на твоём уровне и на всех остальных — рабочие разговоры, споры, неловкие паузы, живой темп.
              </p>
              <button onClick={() => router.push('/auth')} style={{
                background: '#f59e0b', border: 'none', color: 'white', cursor: 'pointer',
            ...
            <div style={{
              ...
              <p style={{ color: '#666', fontSize: '15px', marginBottom: '20px', lineHeight: 1.5 }}>
                ...
                набирается несколько десятков. Дальше — все 180 уроков курса: уроки на твоём уровне
                и на всех остальных — рабочие разговоры, споры, неловкие паузы, живой темп.
              </p>
