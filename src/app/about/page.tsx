  ...
  return (
    ...
    >
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <p className="text-stone-700 mb-3">
          Курс охватывает уровни от A1 до C2 по шкале CEFR — всего 180 уроков. Первые
          Первые 3 урока уровня A1 и первый урок каждого следующего уровня доступны бесплатно. Доступ к остальным урокам предоставляется по подписке.
        </p>
