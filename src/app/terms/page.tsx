      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <section className="prose prose-stone max-w-none text-stone-700 space-y-6">
          ...
          <div>
            ...
            <p>
          2.3. Первые 3 урока уровня A1, а также первый урок каждого из уровней A2, B1, B2 и C1 предоставляются Пользователю бесплатно. Перечень бесплатных уроков может быть изменён Администрацией.
              Доступ к остальным урокам уровней A1, A2, B1, B2, C1, C2 предоставляется
              на возмездной основе по условиям выбранного тарифа.
            </p>
          </div>
