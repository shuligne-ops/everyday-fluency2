...
// Для Retrieval Lab важно, чтобы AI-проверка реально работала в preview-сборке,
// поэтому здесь используется тот же стабильный Anthropic model id, что и в
// основном LLM-слое приложения.
// ─────────────────────────────────────────────────────────────────────────────
